      ...
      <div className="about__container">
        ...
        <div className={`about__content`} ref={aboutDescription}>
          ...
          <p className="about__content--description">
            ...
            breathtaking marvel. Our forte lies in top-notch siding and
            remodeling of the house, designed to not only elevate the aesthetic
            appeal of your home but also fortify it against inclement weather
            conditions. With our seasoned team of experts, we guarantee to
            shepherd you through the entirety of the project, ensuring that your
            envisioned transformation is impeccably realized.
          </p>
